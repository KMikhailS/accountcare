...
public abstract class AbstractDictionarySettingsFrame extends JFrame
		implements SaveValueListener, ReconfigureAccountFormListener {
	...
	private final ReconfigureAccountFormListener listener;
	...
	public void init() {
		...
		okButton.addActionListener(e -> reconfigureAccountForm());
	...
	public void reconfigureAccountForm() {
		listener.reconfigureAccountForm();
		this.dispose();
	}
